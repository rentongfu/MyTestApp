...
extern "C"
JNIEXPORT void JNICALL Java_com_tongfu_mytestapp_ndk_hellogl2_GL2JniLib_init(JNIEnv * env, jclass type,  jint width, jint height)
{
    setupGraphics(width, height);
}
extern "C"
JNIEXPORT void JNICALL Java_com_tongfu_mytestapp_ndk_hellogl2_GL2JniLib_step(JNIEnv * env,  jclass type)
{
    renderFrame();
}
extern "C"
