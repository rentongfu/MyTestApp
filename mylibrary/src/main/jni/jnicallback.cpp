...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass  clz = env->FindClass("com/tongfu/mytestapp/ndk/jnicallback/JniHandler");
...
Java_com_tongfu_mytestapp_ndk_jnicallback_JniCallbackActivity_stopTicks(JNIEnv *env,
                                                                        jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_tongfu_mytestapp_ndk_jnicallback_JniCallbackActivity_startTicks(JNIEnv *env,
                                                                         jobject instance) {
...
Java_com_tongfu_mytestapp_ndk_jnicallback_JniCallbackActivity_stringFromJni(JNIEnv *env,
                                                                            jobject instance) {
#if defined(__arm__)
